...
return [
    'modules' => [
        ...
        'Amasty_Geoip' => 1,
        'PayPal_Braintree' => 1,
        'Amasty_CheckoutCore' => 0,
        'Amasty_CheckoutGiftWrap' => 0,
        'Amasty_CheckoutGraphQl' => 0,
        'Amasty_CheckoutLayoutBuilder' => 0,
        'Amasty_CheckoutProPackage' => 0,
        'Amasty_CheckoutStyleSwitcher' => 0,
        'Amasty_CheckoutThankYouPage' => 0,
        ...
        'Amazon_Login' => 1,
        'Amazon_Payment' => 1,
        'Antti_ConfigurableProductSplitter' => 1,
        'Codilar_Gst' => 0,
        'Dev_Athlete' => 1,
        'Dev_Auth' => 1,
        'Dev_Blog' => 1,
        'Dev_CheckoutSummary' => 1,
        'Dev_RestApi' => 1,
        'Dolphin_CartEdit' => 1,
        ...
        'Mageplaza_Search' => 1,
        'Mageplaza_Shopbycate' => 1,
        'Mageplaza_Smtp' => 1,
        'Mageplaza_Osc' => 1,
        'Magepow_Core' => 1,
        'Magepow_PdfInvoiceFrontend' => 1,
        'Magepow_Sizechart' => 1,
        'Mageprince_Base' => 1,
        'Mageprince_BuyNow' => 1,
        'Mageprince_Faq' => 1,
        ...
        'Razorpay_Magento' => 1,
        'Rb_BrandReviewSlider' => 1,
        'Rb_BrandSlider' => 1,
        'Rb_ExtendAjaxwishlist' => 1,
        'Rb_ExtendProductList' => 0,
        'Rb_RecentView' => 1,
        'Shiprocket_OrderDeliveryStatus' => 1,
        'Smartwave_Core' => 1,
        ...
        'Wishlist_Customwishlist' => 1,
        'Wishtech_ProductZoom' => 1,
        'Yotpo_Yotpo' => 1
    ]
];
