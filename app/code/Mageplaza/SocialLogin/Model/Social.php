...
class Social extends AbstractModel
{
    ...
    {
        $this->_logger->debug('testcalling getCustomerBySocial ');
    ...
    public function getCustomerByEmail($email, $websiteId = null)
    {
         ...
         */
        $this->_logger->debug('testcalling getCustomerByEmail ');
    ...
    public function createCustomerSocial($data, $store)
    {
         ...
         */
        $this->_logger->debug('testcalling createCustomerSocial ');
        ...
        try {
            $this->_logger->debug('testcalling createCustomerSocial try');

            if ($data['password'] !== null) {
                $this->_logger->debug('testcalling createCustomerSocial try if');
                ...
                $this->_logger->debug('testcalling createCustomerSocial try else');
            ...
            $this->_logger->debug('testcalling createCustomerSocial _eventManager');
