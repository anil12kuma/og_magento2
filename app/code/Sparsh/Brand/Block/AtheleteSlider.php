 ...
 * @link     https://www.sparsh-technologies.com
 */
class AtheleteSlider extends Template implements \Magento\Widget\Block\BlockInterface
{
    /**
     * StoreManager
     *
    ...
    {
        parent::_construct();
        $this->setTemplate("Sparsh_Brand::athelete_slider.phtml");
    }
    ...
    public function getBrandCollection()
    {
        ...
        //                     'description'=>$this->escapeHtml($brand->getDescription()),
        ...
        curl_setopt_array($curl, array(
          CURLOPT_URL => 'production.wildcountry.in/wp-json/wcy/V3/get_athlete',
    ...
    public function getResizeUrl($image, $width = null, $height = null)
    {
        ...
        $imageResized = $this->filesystem
            ->getDirectoryRead(
                \Magento\Framework\App\Filesystem\DirectoryList::MEDIA
            )->getAbsolutePath('sparsh/brand/').$resizedImage;
