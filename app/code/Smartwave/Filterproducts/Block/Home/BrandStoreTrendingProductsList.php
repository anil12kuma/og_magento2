...
class BrandStoreTrendingProductsList extends \Magento\Catalog\Block\Product\ListProduct {
    ...
    public function getProducts() {
        ...
        $brandType = $this->getData('brand_type') ? $this->getData('brand_type') : '';
        ...
        if(isset($category) && $category) {
            $collection->addMinimalPrice()
                ...
                ->addUrlRewrite()
                ->addAttributeToFilter('manufacturer', $brandType, 'left')
