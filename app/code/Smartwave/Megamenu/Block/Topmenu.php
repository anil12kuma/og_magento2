        ...
        if(!$max_level || ($max_level && $max_level == 0) || ($max_level && $max_level > 0 && $max_level-1 >= $level)) {
            ...
            foreach($children as $child) {
                ...
                if (!$sw_menu_hide_item) {
                    ...
                    if(count($sub_children) > 0) {
                        $html .= '<div class="open-toggle child-parent"><svg xmlns="http://www.w3.org/2000/svg" class="plus" width="100" height="100" viewBox="0 0 160 160">
  <rect class="vertical-line" x="65" y="22" width="10" height="120"></rect>
  <rect class="horizontal-line" y="75" x="14" width="120" height="10"></rect>
</svg></div>';
                    }
                    ...
                    $html .= '<a href="'.$this->_categoryHelper->getCategoryUrl($child).'" title="'.$child->getName().'" target="_new">';
                    if ($level > 1 && $sw_menu_icon_img)
    ...
    public function getMegamenuHtml()
    {
        ...
        foreach($categories as $category) {
            ...
            if(!$sw_menu_hide_item) {
                ...
                if(count($children) > 0) {
                    $html .= '<div class="open-toggle top-parent"><svg xmlns="http://www.w3.org/2000/svg" class="plus" width="100" height="100" viewBox="0 0 160 160">
  <rect class="vertical-line" x="65" y="22" width="10" height="120"></rect>
  <rect class="horizontal-line" y="75" x="14" width="120" height="10"></rect>
</svg></div>';
                }
                // $html .= '<a href="'.$this->_categoryHelper->getCategoryUrl($category).'" class="level-top" title="'.$category->getName().'">';
                $html .= '<a class="level-top" title="'.$category->getName().'">';
                if ($sw_menu_icon_img)
