...
class CheckoutHelper extends AbstractHelper
{
    ...
    const XML_PATH_PHONELOGIN_TELEPHONE_INPUT_MODULE_ENABLED = 'mega_phonelogin/checkout_config/enabled_checkout';

    const XML_PATH_PHONELOGIN_TELEPHONE_MULTISELECT_COUNTRIES_ALLOWED = 'mega_phonelogin/checkout_config/allow';
    ...
    {
        return $this->getConfig(self::XML_PATH_PHONELOGIN_TELEPHONE_INPUT_MODULE_ENABLED);
    }
    ...
    {
        return $this->getConfig(self::XML_PATH_PHONELOGIN_TELEPHONE_MULTISELECT_COUNTRIES_ALLOWED);
    }
    ...
    public function telephoneFieldConfig($addressType, $method = '')
    {
        return  [
            ...
            'config' => [
                ...
                'elementTmpl' => 'Mega_Phonelogin/form/element/telephone',
                'tooltip' => [
