...
namespace Meetanshi\IndianGst\Model\Rewrite\Order\Pdf\Items\Creditmemo;

use Magento\Sales\Model\Order\Pdf\Items\Creditmemo\DefaultCreditmemo;
use Magento\Framework\App\ObjectManager;

class PrintCreditmemo extends DefaultCreditmemo
{
    public function draw()
    {
        ...
        $itemTotal = $itemData->getRowTotal()  - $itemData->getDiscountAmount();
