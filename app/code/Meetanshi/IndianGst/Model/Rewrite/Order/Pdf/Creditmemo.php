...
class Creditmemo  extends AbstractPdf
{
    ...
    public function afterGetPdf(\Magento\Sales\Model\Order\Pdf\Creditmemo $creditmemoClass, $result, $creditmemos = [])
    {
        $this->_beforeGetPdf();
        ...
        try {
            ...
            foreach ($creditmemos as $creditmemo) {
                if ($creditmemo->getStoreId()) {
                    $this->localeResolver->emulate($creditmemo->getStoreId());

                    $this->storeManager->setCurrentStore($creditmemo->getStoreId());
                }
                $page = $this->newPage();
                ...
                $this->insertDocumentNumber($page, __('Creditmemo # ') . $creditmemo->getIncrementId());
    ...
    protected function insertOrder(&$page, $obj, $putOrderId = true)
    {
        ...
        $page->drawText(__('Tax Creditmemo/Bill of Supply/Cash Memo'), 325, $top += 50, 'UTF-8');
