...
class PaymentMethod extends \Magento\Payment\Model\Method\AbstractMethod
{
    ...
    */
	...
	public function getPostHTML($order, $storeId = null)
    {
		...
		$phone_no = $billingAddress->getData('telephone');
        ...
        $logger->info(print_r($layer_payment_token_data, true));
        $logger->info('text message end');
		...
		if(empty($error) && !empty($payment_token_data)){
			...
			$html .= "function triggerLayer() {							
							Layer.checkout(
							{
                                ...
                                theme: {
                                    logo : 'https://www.mywildcountry.com/media/logo/stores/1/paylogo.png',
                                    color: '#36656D',
                                    error_color : '#ff2b2b'
                                }
							},
